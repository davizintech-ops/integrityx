ui_print "  ___       _                    _ _"
ui_print " |_ _|_ __ | |_ ___  __ _ _ __ (_) |_ _  _"
ui_print "  | || '_ \| __/ _ \/ _\` | '_ \| |  _| || |"
ui_print "  | || | | | ||  __/ (_| | | | | | | | || |"
ui_print " |___|_| |_|\__\___|\__,_|_| |_|_|\__|\_, |"
ui_print "                                      |__/"
ui_print ""
ui_print "              __  __"
ui_print "              \ \/ /"
...
if [ "$API" -lt 26 ]; then
    ...
    ui_print "  ╠══════════════════════════════╣"
    ui_print "  ║                              ║"
    ui_print "  ║  ✕ UNSUPPORTED ANDROID       ║"
    ui_print "  ║                              ║"
    ui_print "  ║  Android 8.0+ is required.   ║"
    ui_print "  ║                              ║"
    ui_print "  ║  Your API: $API              ║"
    ui_print "  ║  Required: API 26+           ║"
    ui_print "  ║                              ║"
    ui_print "  ╚══════════════════════════════╝"
    ui_print ""
...
ui_print "Your android is supported! (sdk $API)"
...
if [ -d /data/adb/modules/playintegrityfix/system ]; then
    ui_print "- 「INFO」Restoring disabled ROM apps configuration"
...
ui_print "      welcome to IntegrityX!"
